...
use Visualbuilder\Versionable\Diff;
...
class DiffTest extends TestCase
{
    ...
    public function test_it_can_return_the_diff_statistics()
    {
    ...
    public function test_it_can_return_correct_statistics_for_new_line_insertions()
    {
        $old = new Version(['contents' => ['title' => 'example title', 'content' => 'example content']]);
    ...
    public function test_it_can_return_correct_statistics_for_deleted_lines()
    {
        $old = new Version(['contents' => ['title' => 'example title', 'content' => "example content\n adding new line \n another new line"]]);
    ...
    public function test_it_can_return_correct_statistics_for_unmodified_lines()
    {
        $old = new Version(['contents' => ['title' => 'example title', 'content' => "example content\n adding new line \n another new line"]]);
    ...
    public function test_it_can_return_correct_statistics_for_added_keys()
    {
