...
/**
 * @property \Illuminate\Database\Eloquent\Collection<\Visualbuilder\Versionable\Version> $versions
 */
trait Versionable
{
    ...
    public static function bootVersionable(): void
    {
        static::created(function (Model $model) {
            if (static::$versioning) {
                ...
                /** @var \Visualbuilder\Versionable\Versionable|Model $model */
        ...
        static::updating(function (Model $model) {
            ...
            /** @var \Visualbuilder\Versionable\Versionable $model */
        ...
        static::deleted(
            function (Model $model) {
                /* @var \Visualbuilder\Versionable\Versionable|\Visualbuilder\Versionable\Version$model */
    ...
    {
        /** @var \Visualbuilder\Versionable\Versionable|Model $refreshedModel */
    ...
    public function getVersionUser(): ?Model
    {
        return auth()->user();
    }
